...
# bat_dp <- dplyr::inner_join(read.csv("data/raw/ATLANTIC_BATS_Capture.csv"),
#                 read.csv("data/raw/ATLANTIC_BATS_Study_site.csv"), by = "ID")
#
...
# what the hell
head(read.csv("data/raw/Dataset/ATLANTIC-PR_Occurrence.csv"))

# What the hell 2
mamagain <- read.csv("data/raw/Mammals_UPRB_study_sites.csv")
