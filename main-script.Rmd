...
if(file.exists("data/data.Rdata")){
  ...
  #gbif <- occ_download_import(as.download("data/raw/0023533-180131172636756.zip"))
  ...
  # Save everything
  save(c(gbif, amp_dp, bat_dp, mamsmall_dp, mamsmall2_dp, mamct_dp, mamprim, birds_dp, idigbio), "data/raw/occ_data.Rdata")
