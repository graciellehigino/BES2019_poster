...
# Camtraps Mammals
mamct_dp <- dplyr::inner_join(read.csv("data/raw/ATLANTIC_SM_Study_Site.csv"),
                read.csv("data/raw/ATLANTIC_SM_Capture.csv"), by = "ID.")
...
# What the hell 2
sites <- read.csv("data/raw/Mammals_UPRB_study_sites.csv") #esse tá ok
sp <- readr::read_csv("data/raw/Mammals_UPRB_species.csv") # esse tá uma desgraça

#TODO rearranjar colunas "site_x" em uma única coluna com 52 fatores idênticos a levels(sites$site)

mamagain <- dplyr::inner_join(sites, species, by = "site")

save(c(gbif, amp_dp, mamct_dp, mamsmall_dp, mamagain, birds_dp), "occ_data.Rdata")
